...
-- --------------------------------------
-- DSM-CC SSP Dissector CMM
-- Server-side SSP Messages
-- DNCS & CMM
-- TCP Transport
-- 
-- script-name: twcssp_cmm_server.lua
-- Version 0.3
--
...
local message_types = {
    ...
    [32800] = "Server Session Release Request",         -- 0x8020
    [32801] = "Server Session Release Confirm",         -- 0x8021
    [32802] = "Server Session Release Indication",      -- 0x8022
    [32803] = "Server Session Release Response",        -- 0x8023
...
local status_type = {
    [0] = "Reserved",
    [1] = "Identify Session List",
    [2] = "Identify Session Status",
    [3] = "Identify Configuration",
    [4] = "Query Resource Descriptor",
    [5] = "Query Resource Status"
}

-- creates a Proto object, but doesn't register it yet
local twcssp = Proto("dsmcc_ssp_tcp","Pegasus Session Setup Protocol (Server-Side)")
...
ssp_fields = {}
-- dsmcc header
ssp_fields.pf_protocol_descriminator = ProtoField.uint8("dsmcc_ssp_tcp.protocol_descriminator", "Protocol Descriminator", base.HEX, discriminator)
ssp_fields.pf_dsmcc_type             = ProtoField.uint8("dsmcc_ssp_tcp.dsmcc_type", "DSMCC Type", base.HEX, dsmcc_types)
ssp_fields.pf_message_id             = ProtoField.uint16("dsmcc_ssp_tcp.message_id", "Message ID", base.HEX, message_types)
ssp_fields.pf_message_discriminator  = ProtoField.uint16("dsmcc_ssp_tcp.message_discriminator", "Discriminator", base.HEX, message_discriminator, 0xC000)
ssp_fields.pf_message_scenario       = ProtoField.uint16("dsmcc_ssp_tcp.message_scenario", "Scenario", base.HEX, message_scenario, 0x3FF0)
ssp_fields.pf_message_type           = ProtoField.uint16("dsmcc_ssp_tcp.message_type", "Type", base.HEX, message_type, 0x000F)
ssp_fields.pf_transaction_id         = ProtoField.new("Transaction ID", "dsmcc_ssp_tcp.transaction_id", ftypes.BYTES)
ssp_fields.pf_flag_transactionid_originator = ProtoField.uint32("dsmcc_ssp_tcp.flag_transactionid_originator", "Originator", base.DEC, transid_originator, 0xC0000000)
ssp_fields.pf_flag_transactionid_number     = ProtoField.new("Value", "dsmcc_ssp_tcp.flag_transactionid_number", ftypes.UINT32, nil, base.DEC, 0x3FFFFFFF)
ssp_fields.pf_reserved               = ProtoField.new("Reserved", "dsmcc_ssp_tcp.reserved", ftypes.BYTES)
ssp_fields.pf_adaptation_length      = ProtoField.new("Adaptation Length", "dsmcc_ssp_tcp.adaptation_length", ftypes.UINT8)
ssp_fields.pf_adaptation_type        = ProtoField.uint8("dsmcc_ssp_tcp.adaptation_type", "Adaptation Type", base.HEX, adaptation_type)
ssp_fields.pf_adaptation_data        = ProtoField.new("Adaptation Data", "dsmcc_ssp_tcp.adaptation_data", ftypes.BYTES)
...
ssp_fields.pf_adaptation_nsap_afi    = ProtoField.new("User NSAP (AFI)", "dsmcc_ssp_tcp.adaptation_nsap_afi", ftypes.BYTES)
ssp_fields.pf_adaptation_icd         = ProtoField.new("International Code Designator (ICD)", "dsmcc_ssp_tcp.adaptation_icd", ftypes.BYTES)
ssp_fields.pf_adaptation_ip          = ProtoField.new("User IP (HO_DSP)", "dsmcc_ssp_tcp.adaptation_ip", ftypes.IPv4)
ssp_fields.pf_adaptation_mac         = ProtoField.new("User MAC (ESI)", "dsmcc_ssp_tcp.adaptation_mac", ftypes.ETHER)
ssp_fields.pf_adaptation_sel         = ProtoField.new("NSAP Selector (SEL)", "dsmcc_ssp_tcp.adaptation_sel", ftypes.BYTES)
ssp_fields.pf_message_length         = ProtoField.new("Message Length Payload", "dsmcc_ssp_tcp.message_length", ftypes.UINT16)
-- session count
ssp_fields.pf_session_count          = ProtoField.new("Session Count","dsmcc_ssp_tcp.session_count", ftypes.UINT16)
-- session id
ssp_fields.pf_stb_address            = ProtoField.new("STB MAC Address", "dsmcc_ssp_tcp.stb_address", ftypes.ETHER)
ssp_fields.pf_session_number         = ProtoField.new("Session Number", "dsmcc_ssp_tcp.session_number", ftypes.UINT32)
-- return codes
ssp_fields.pf_response               = ProtoField.uint16("dsmcc_ssp_tcp.response", "Response Code", base.HEX, response_codes)
ssp_fields.pf_reason                 = ProtoField.uint16("dsmcc_ssp_tcp.reason", "Reason Code", base.HEX, reason_codes)
-- client nsap, E.164 ATM
ssp_fields.pf_client_nsap_afi        = ProtoField.new("Client NSAP (AFI)", "dsmcc_ssp_tcp.client_nsap_api", ftypes.BYTES)
ssp_fields.pf_client_icd             = ProtoField.new("International Code Designator (ICD)", "dsmcc_ssp_tcp.client_icd", ftypes.BYTES)
ssp_fields.pf_client_ip              = ProtoField.new("Client IP (HO_DSP)", "dsmcc_ssp_tcp.client_ip", ftypes.IPv4)
ssp_fields.pf_client_mac             = ProtoField.new("Client MAC (ESI)", "dsmcc_ssp_tcp.client_mac", ftypes.ETHER)
ssp_fields.pf_client_sel             = ProtoField.new("NSAP Selector (SEL)", "dsmcc_ssp_tcp.client_sel", ftypes.BYTES)
-- server nsap, E.164 ATM
ssp_fields.pf_server_nsap_afi        = ProtoField.new("Server NSAP (AFI)", "dsmcc_ssp_tcp.server_nsap_api", ftypes.BYTES)
ssp_fields.pf_server_icd             = ProtoField.new("International Code Designator (ICD)", "dsmcc_ssp_tcp.server_icd", ftypes.BYTES)
ssp_fields.pf_server_ip              = ProtoField.new("Server IP (HO_DSP)", "dsmcc_ssp_tcp.server_ip", ftypes.IPv4)
ssp_fields.pf_server_mac             = ProtoField.new("Server MAC (ESI)", "dsmcc_ssp_tcp.server_mac", ftypes.ETHER)
ssp_fields.pf_server_sel             = ProtoField.new("NSAP Selector (SEL)", "dsmcc_ssp_tcp.server_sel", ftypes.BYTES)
ssp_fields.pf_server_status_type     = ProtoField.uint16("dsmcc_ssp_tcp.server_status_type", "Status Type", base.HEX, status_type)
ssp_fields.pf_server_status_count    = ProtoField.new("Status Count", "dsmcc_ssp_tcp.server_status_count", ftypes.UINT16)
ssp_fields.pf_server_status_byte     = ProtoField.new("Status Byte", "dsmcc_ssp_tcp.server_status_byte", ftypes.BYTES)
-- user data
ssp_fields.pf_uudata_length          = ProtoField.new("UUData Length", "dsmcc_ssp_tcp.uudata_length", ftypes.UINT16)
ssp_fields.pf_private_data_length    = ProtoField.new("Private Data Length", "dsmcc_ssp_tcp.private_data_length", ftypes.UINT16)
ssp_fields.pf_protocol_id            = ProtoField.new("Protocol ID", "dsmcc_ssp_tcp.protocol_id", ftypes.BYTES)
ssp_fields.pf_version                = ProtoField.new("Protocol Version", "dsmcc_ssp_tcp.version", ftypes.BYTES)
ssp_fields.pf_descriptor_count       = ProtoField.new("Descriptor Count", "dsmcc_ssp_tcp.descriptor_count", ftypes.UINT8)
-- descriptor 01 asset id
ssp_fields.pf_desc_asset_id_tag              = ProtoField.new("Asset ID Tag", "dsmcc_ssp_tcp.desc_asset_id_tag", ftypes.UINT8)
ssp_fields.pf_desc_asset_id_length           = ProtoField.new("Asset ID Length", "dsmcc_ssp_tcp.desc_asset_id_length", ftypes.UINT8)
...
ssp_fields.pf_desc_nodegroup_id_tag          = ProtoField.new("Node Group ID Tag", "dsmcc_ssp_tcp.desc_nodegroup_id_tag", ftypes.UINT8)
ssp_fields.pf_desc_nodegroup_id_length       = ProtoField.new("Node Group ID Length", "dsmcc_ssp_tcp.desc_nodegroup_id_length", ftypes.UINT8)
ssp_fields.pf_desc_nodegroup_id_data         = ProtoField.new("Node Group ID Data", "dsmcc_ssp_tcp.desc_nodegroup_id_data", ftypes.BYTES)
-- descriptor 03 ip
ssp_fields.pf_desc_ip_tag                    = ProtoField.new("IP Tag", "dsmcc_ssp_tcp.desc_ip_tag", ftypes.UINT8)
ssp_fields.pf_desc_ip_length                 = ProtoField.new("IP Length", "dsmcc_ssp_tcp.desc_ip_length", ftypes.UINT8)
ssp_fields.pf_desc_ip_data_port              = ProtoField.new("IP Port", "dsmcc_ssp_tcp.desc_ip_data_port", ftypes.UINT16)
ssp_fields.pf_desc_ip_data                   = ProtoField.new("IP Address", "dsmcc_ssp_tcp.desc_ip_data", ftypes.IPv4)
-- descriptor 04 stream handle
ssp_fields.pf_desc_stream_handle_tag         = ProtoField.new("Stream Handle Tag", "dsmcc_ssp_tcp.desc_stream_handle_tag", ftypes.UINT8)
ssp_fields.pf_desc_stream_handle_length      = ProtoField.new("Stream Handle Length", "dsmcc_ssp_tcp.desc_stream_handle_length", ftypes.UINT8)
ssp_fields.pf_desc_stream_handle_data        = ProtoField.new("Stream Handle Data", "dsmcc_ssp_tcp.desc_stream_handle_data", ftypes.UINT32)
-- descriptor 05 application request data
ssp_fields.pf_desc_app_request_tag           = ProtoField.new("Application Request Tag", "dsmcc_ssp_tcp.desc_app_request_tag", ftypes.UINT8)
ssp_fields.pf_desc_app_request_length        = ProtoField.new("Application Request Length", "dsmcc_ssp_tcp.desc_app_request_length", ftypes.UINT8)
ssp_fields.pf_desc_app_request_data          = ProtoField.new("Application Request Data", "dsmcc_ssp_tcp.desc_app_request_data", ftypes.STRING)
ssp_fields.pf_desc_app_request_purchase_type = ProtoField.uint8("dsmcc_ssp_tcp.desc_app_request_purchase_type", "Purchase Type", base.HEX, purchase_type_request)
ssp_fields.pf_desc_app_request_rental_list_start = ProtoField.new("Rental List Request Start", "dsmcc_ssp_tcp.desc_app_request_rental_list_start", ftypes.UINT8)
ssp_fields.pf_desc_app_request_rental_list_count = ProtoField.new("Rental List Request Count", "dsmcc_ssp_tcp.desc_app_request_rental_list_count", ftypes.UINT8)
ssp_fields.pf_desc_app_request_service_name      = ProtoField.new("Service Name", "dsmcc_ssp_tcp.desc_app_request_service_name", ftypes.STRING)
-- descriptor 06 application response data
ssp_fields.pf_desc_app_response_tag           = ProtoField.new("Application Response Tag", "dsmcc_ssp_tcp.desc_app_response_tag", ftypes.UINT8)
ssp_fields.pf_desc_app_response_length        = ProtoField.new("Application Response Length", "dsmcc_ssp_tcp.desc_app_response_length", ftypes.UINT8)
ssp_fields.pf_desc_app_response_data          = ProtoField.new("Application Response Data", "dsmcc_ssp_tcp.desc_app_response_data", ftypes.STRING)
ssp_fields.pf_desc_app_response_purchase_type = ProtoField.uint8("dsmcc_ssp_tcp.desc_app_response_purchase_type", "Purchase Type", base.HEX, purchase_type_response)
ssp_fields.pf_desc_app_response_failure_code  = ProtoField.uint8("dsmcc_ssp_tcp.desc_app_response_failure", "Response Failure", base.HEX, response_failure_code)
ssp_fields.pf_desc_app_response_purchase_id   = ProtoField.new("Purchase ID", "dsmcc_ssp_tcp.desc_app_response_purchase_id", ftypes.UINT32)
ssp_fields.pf_desc_app_response_offering_id   = ProtoField.new("Offering ID", "dsmcc_ssp_tcp.desc_app_response_offering_id", ftypes.UINT32)
ssp_fields.pf_desc_app_response_num_subs      = ProtoField.new("Number of Subscriptions", "dsmcc_ssp_tcp.desc_app_response_num_subs", ftypes.UINT8)
ssp_fields.pf_desc_app_response_sub_expiry    = ProtoField.new("Subscription Expiration", "dsmcc_ssp_tcp.desc_app_response_sub_expiry", ftypes.ABSOLUTE_TIME)
-- descriptor 17 folder id
ssp_fields.pf_desc_folderid_tag       = ProtoField.new("Folder ID Tag", "dsmcc_ssp_tcp.desc_app_folderid_tag", ftypes.UINT8)
ssp_fields.pf_desc_folderid_length    = ProtoField.new("Folder ID Length", "dsmcc_ssp_tcp.desc_app_folderid_length", ftypes.UINT8)
ssp_fields.pf_desc_folderid_data      = ProtoField.new("Folder ID Data", "dsmcc_ssp_tcp.desc_app_folderid_data", ftypes.BYTES)
-- descriptor 18 unit address (undocumented)
ssp_fields.pf_desc_ua_tag             = ProtoField.new("Unit Address Tag", "dsmcc_ssp_tcp.desc_ua_tag", ftypes.UINT8)
ssp_fields.pf_desc_ua_length          = ProtoField.new("Unit Address Length", "dsmcc_ssp_tcp.desc_ua_length", ftypes.UINT8)
ssp_fields.pf_desc_ua_data            = ProtoField.new("Unit Address Data", "dsmcc_ssp_tcp.desc_ua_data", ftypes.STRING)

-- descriptor 240 transport stream id
ssp_fields.pf_desc_tsid_tag           = ProtoField.new("Transport Stream ID Tag", "dsmcc_ssp_tcp.desc_tsid_tag", ftypes.UINT8)
ssp_fields.pf_desc_tsid_length        = ProtoField.new("Transport Stream Length", "dsmcc_ssp_tcp.desc_tsid_length", ftypes.UINT8)
ssp_fields.pf_desc_tsid_data          = ProtoField.new("Transport Stream Data", "dsmcc_ssp_tcp.desc_tsid_data", ftypes.UINT16)
-- MBO descriptors
-- descriptor 177 offering id
ssp_fields.pf_desc_offering_id_tag    = ProtoField.new("Offering ID Tag", "dsmcc_ssp_tcp.desc_offering_id_tag", ftypes.UINT8)
ssp_fields.pf_desc_offering_id_length = ProtoField.new("Offering ID Length", "dsmcc_ssp_tcp.desc_offering_id_length", ftypes.UINT8)
ssp_fields.pf_desc_offering_id_flags  = ProtoField.uint8("dsmcc_ssp_tcp.desc_offering_id_flags", "Offering ID Flags", base.HEX, offering_flags)
ssp_fields.pf_desc_offering_id        = ProtoField.new("Offering ID", "dsmcc_ssp_tcp.desc_offering_id", ftypes.UINT32)
-- descriptor 178 network play time
ssp_fields.pf_desc_network_play_time_tag    = ProtoField.new("Network Play Time Tag", "dsmcc_ssp_tcp.desc_network_play_time_tag", ftypes.UINT8)
ssp_fields.pf_desc_network_play_time_length = ProtoField.new("Network Play Time Length", "dsmcc_ssp_tcp.desc_network_play_time_length", ftypes.UINT8)
ssp_fields.pf_desc_network_play_time        = ProtoField.new("Network Play Time (ms)", "dsmcc_ssp_tcp.desc_network_play_time", ftypes.UINT32)
-- descriptor 179 duration
ssp_fields.pf_desc_duration_tag    = ProtoField.new("Duration Tag", "dsmcc_ssp_tcp.desc_duration_tag", ftypes.UINT8)
ssp_fields.pf_desc_duration_length = ProtoField.new("Duration Length", "dsmcc_ssp_tcp.desc_duration_length", ftypes.UINT8)
ssp_fields.pf_desc_duration        = ProtoField.new("Duration (ms)", "dsmcc_ssp_tcp.desc_duration", ftypes.UINT32)
-- descriptor 181 client session code
ssp_fields.pf_desc_client_session_teardown_code_tag    = ProtoField.new("Client Session Teardown Code Tag", "dsmcc_ssp_tcp.desc_client_session_teardown_code_tag", ftypes.UINT8)
ssp_fields.pf_desc_client_session_teardown_code_length = ProtoField.new("Client Session Teardown Code Length", "dsmcc_ssp_tcp.desc_client_session_teardown_code_length", ftypes.UINT8)
ssp_fields.pf_desc_client_session_teardown_code        = ProtoField.uint8("dsmcc_ssp_tcp.desc_client_session_teardown_code", "Client Session Teardown Code", base.HEX, client_session_teardown_code)
-- descriptor 184 mystro session id
ssp_fields.pf_desc_mystro_session_id_tag    = ProtoField.new("Mystro Session ID Tag", "dsmcc_ssp_tcp.desc_mystro_session_id_tag", ftypes.UINT8)
ssp_fields.pf_desc_mystro_session_id_length = ProtoField.new("Mystro Session ID Length", "dsmcc_ssp_tcp.desc_mystro_session_id_length", ftypes.UINT8)
ssp_fields.pf_desc_mystro_session_id        = ProtoField.new("Mystro Session ID", "dsmcc_ssp_tcp.desc_mystro_session_id", ftypes.UINT32)
-- descriptor 186 upsell request
ssp_fields.pf_desc_upsell_request_tag    = ProtoField.new("Upsell Request Tag", "dsmcc_ssp_tcp.desc_upsell_request_tag", ftypes.UINT8)
ssp_fields.pf_desc_upsell_request_length = ProtoField.new("Upsell Request Length", "dsmcc_ssp_tcp.desc_upsell_request_length", ftypes.UINT8)
ssp_fields.pf_desc_upsell_request        = ProtoField.new("Upsell Request", "dsmcc_ssp_tcp.desc_upsell_request", ftypes.UINT32)
-- descriptor 187 upsell result
ssp_fields.pf_desc_upsell_result_tag    = ProtoField.new("Upsell Result Tag", "dsmcc_ssp_tcp.desc_upsell_result_tag", ftypes.UINT8)
ssp_fields.pf_desc_upsell_result_length = ProtoField.new("Upsell Result Length", "dsmcc_ssp_tcp.desc_upsell_result_length", ftypes.UINT8)
ssp_fields.pf_desc_upsell_result        = ProtoField.new("Upsell Result", "dsmcc_ssp_tcp.desc_upsell_result", ftypes.UINT8)
...
ssp_fields.pf_desc_mprovider_tag         = ProtoField.new("Provider and Asset Tag", "dsmcc_ssp_tcp.desc_mprovider_tag", ftypes.UINT8)
ssp_fields.pf_desc_mprovider_length      = ProtoField.new("Descriptor Length", "dsmcc_ssp_tcp.desc_mprovider_length", ftypes.UINT8)
ssp_fields.pf_desc_mprovider_id_length   = ProtoField.new("Provider ID Length", "dsmcc_ssp_tcp.desc_mprovider_id_length", ftypes.UINT8)
ssp_fields.pf_desc_mprovider_id          = ProtoField.new("Provider ID", "dsmcc_ssp_tcp.desc_mprovider_id", ftypes.STRING)
ssp_fields.pf_desc_masset_id_length      = ProtoField.new("Asset ID Length", "dsmcc_ssp_tcp.desc_masset_id_length", ftypes.UINT8)
ssp_fields.pf_desc_masset_id             = ProtoField.new("Asset ID", "dsmcc_ssp_tcp.desc_masset_id", ftypes.STRING)
-- descriptor 193 vod cross stream protection
ssp_fields.pf_desc_vod_cross_tag         = ProtoField.new("VOD Cross Stream Protection Tag", "dsmcc_ssp_tcp.desc_vod_cross_tag", ftypes.UINT8)
ssp_fields.pf_desc_vod_cross_length      = ProtoField.new("VOD Cross Stream Protection Length", "dsmcc_ssp_tcp.desc_vod_cross_length", ftypes.UINT8)
ssp_fields.pf_desc_vod_cross             = ProtoField.new("VOD Cross Stream Protection (CRC32)", "dsmcc_ssp_tcp.desc_vod_cross", ftypes.BYTES)
-- descriptor 194 vod segment
ssp_fields.pf_desc_vod_segment_tag       = ProtoField.new("VOD Segment Tag", "dsmcc_ssp_tcp.desc_vod_segment_tag", ftypes.UINT8)
ssp_fields.pf_desc_vod_segment_length    = ProtoField.new("VOD Segment Length", "dsmcc_ssp_tcp.desc_vod_segment_length", ftypes.UINT8)
ssp_fields.pf_desc_vod_segment_type      = ProtoField.uint8("dsmcc_ssp_tcp.desc_vod_segment_type", "Segment Type", base.HEX, segment_type)
ssp_fields.pf_desc_vod_segment_start_npt = ProtoField.new("VOD Segment Start NPT (ms)", "dsmcc_ssp_tcp.desc_vod_segment_start_npt", ftypes.UINT32)
ssp_fields.pf_desc_vod_segment_duration  = ProtoField.new("VOD Segment Duration (ms)", "dsmcc_ssp_tcp.desc_vod_segment_duration", ftypes.UINT32)
ssp_fields.pf_desc_vod_segment_control   = ProtoField.new("VOD Segment Control", "dsmcc_ssp_tcp.desc_vod_segment_control", ftypes.BYTES)
ssp_fields.pf_desc_vod_segment_control1  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control1", "Pause Allowed", base.DEC, enabled_disabled, 0x0001)
ssp_fields.pf_desc_vod_segment_control2  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control2", "Rewind Allowed", base.DEC, enabled_disabled, 0x0002)
ssp_fields.pf_desc_vod_segment_control3  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control3", "Fast Forward Allowed", base.DEC, enabled_disabled, 0x0004)
ssp_fields.pf_desc_vod_segment_control4  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control4", "Skip Forward Allowed", base.DEC, enabled_disabled, 0x0008)
ssp_fields.pf_desc_vod_segment_control5  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control5", "Skip Back Allowed", base.DEC, enabled_disabled, 0x0010)
ssp_fields.pf_desc_vod_segment_control6  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control6", "Slow Motion Allowed", base.DEC, enabled_disabled, 0x0020)
ssp_fields.pf_desc_vod_segment_control7  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control7", "Frame-by-Frame Advance Allowed", base.DEC, enabled_disabled, 0x0040)
ssp_fields.pf_desc_vod_segment_control8  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control8", "Instant Replay Allowed", base.DEC, enabled_disabled, 0x0080)
ssp_fields.pf_desc_vod_segment_control9  = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control9", "Segment Control Overridable", base.DEC, enabled_disabled, 0x0100)
ssp_fields.pf_desc_vod_segment_control10 = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control10", "Non-Linear Segment", base.DEC, enabled_disabled, 0x0200)
ssp_fields.pf_desc_vod_segment_control11 = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control11", "Force Play this Segment", base.DEC, enabled_disabled, 0x0400)
ssp_fields.pf_desc_vod_segment_control12 = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control12", "Reserved", base.DEC, enabled_disabled, 0x0800)
ssp_fields.pf_desc_vod_segment_control13 = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control13", "Reserved", base.DEC, enabled_disabled, 0x1000)
ssp_fields.pf_desc_vod_segment_control14 = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control14", "Reserved", base.DEC, enabled_disabled, 0x2000)
ssp_fields.pf_desc_vod_segment_control15 = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control15", "Reserved", base.DEC, enabled_disabled, 0x4000)
ssp_fields.pf_desc_vod_segment_control16 = ProtoField.uint16("dsmcc_ssp_tcp.desc_vod_segment_control16", "Reserved", base.DEC, enabled_disabled, 0x8000)
-- descriptor 195 vod cross stream protection v2
ssp_fields.pf_desc_vod_cross_v2_tag    = ProtoField.new("VOD Cross Stream Protection v2 Tag", "dsmcc_ssp_tcp.desc_vod_cross_v2_tag", ftypes.UINT8)
ssp_fields.pf_desc_vod_cross_v2_length = ProtoField.new("VOD Cross Stream Protection v2 Length", "dsmcc_ssp_tcp.desc_vod_cross_v2_length", ftypes.UINT8)
ssp_fields.pf_desc_vod_cross_v2        = ProtoField.new("VOD Cross Stream Protection v2 (CRC32)", "dsmcc_ssp_tcp.desc_vod_cross_v2", ftypes.BYTES)
-- descriptor 196 video decode type
ssp_fields.pf_desc_video_decode_type_tag    = ProtoField.new("Video Decode Type Tag", "dsmcc_ssp_tcp.desc_video_decode_type_tag", ftypes.UINT8)
ssp_fields.pf_desc_video_decode_type_length = ProtoField.new("Video Decode Type Length", "dsmcc_ssp_tcp.desc_video_decode_type_length", ftypes.UINT8)
ssp_fields.pf_desc_video_decode_type        = ProtoField.uint16("dsmcc_ssp_tcp.desc_video_decode_type", "Video Decode Type", base.HEX, video_decode_type)
-- descriptor 198 entertainment play time
ssp_fields.pf_desc_ent_play_time_tag    = ProtoField.new("Entertainment Play Time Tag", "dsmcc_ssp_tcp.desc_ent_play_time_tag", ftypes.UINT8)
ssp_fields.pf_desc_ent_play_time_length = ProtoField.new("Entertainment Play Time Length", "dsmcc_ssp_tcp.desc_ent_play_time_length", ftypes.UINT8)
ssp_fields.pf_desc_ent_play_time        = ProtoField.new("Entertainment Play Time (ms)", "dsmcc_ssp_tcp.desc_ent_play_time", ftypes.UINT32)
-- descriptor 254 error code
ssp_fields.pf_desc_error_code_tag    = ProtoField.new("Error Code Tag", "dsmcc_ssp_tcp.desc_error_code_tag", ftypes.UINT8)
ssp_fields.pf_desc_error_code_length = ProtoField.new("Error Code Length", "dsmcc_ssp_tcp.desc_error_code_length", ftypes.UINT8)
ssp_fields.pf_desc_error_code        = ProtoField.uint16("dsmcc_ssp_tcp.desc_error_code", "Error Code", base.HEX, error_code)
-- resource descriptors
ssp_fields.pf_resource_count              = ProtoField.new("Resource Count", "dsmcc_ssp_tcp.resource_count", ftypes.UINT16)
-- resource descriptor headers
ssp_fields.pf_resource_request_id         = ProtoField.new("Resource Request ID","dsmcc_ssp_tcp.resource_request_id", ftypes.BYTES)
ssp_fields.pf_resource_desc_type          = ProtoField.uint16("dsmcc_ssp_tcp.resource_desc_type", "Resource Descriptor Type", base.DEC, resource_type)
ssp_fields.pf_resource_num                = ProtoField.new("Resource Number", "dsmcc_ssp_tcp.resource_num", ftypes.BYTES)
ssp_fields.pf_flag_resource_num_assignor  = ProtoField.uint16("dsmcc_ssp_tcp.flag_resource_num_assignor", "Assignor", base.DEC, resource_assignor, 0xC000)
ssp_fields.pf_flag_resource_num_value     = ProtoField.new("Value", "dsmcc_ssp_tcp.flag_resource_num_value", ftypes.UINT16, nil, base.HEX, 0x3FFF)
ssp_fields.pf_resource_association_tag    = ProtoField.new("Resource Association Tag", "dsmcc_ssp_tcp.resource_association_tag", ftypes.BYTES)
ssp_fields.pf_flag_resource_association_tag_assignor = ProtoField.uint16("dsmcc_ssp_tcp.flag_resource_association_tag_assignor", "Assignor", base.DEC, resource_assignor, 0xC000)
ssp_fields.pf_flag_resource_association_tag_value    = ProtoField.new("Value", "dsmcc_ssp_tcp.flag_resource_association_tag_value", ftypes.UINT16, nil, base.HEX, 0x3FFF)
ssp_fields.pf_resource_flags              = ProtoField.new("Resource Flags", "dsmcc_ssp_tcp.resource_flags", ftypes.BYTES)
ssp_fields.pf_resource_flags_view         = ProtoField.uint8("dsmcc_ssp_tcp.resource_flags_view", "View", base.HEX, resource_view, 0xC0)
ssp_fields.pf_resource_flags_attribute    = ProtoField.uint8("dsmcc_ssp_tcp.resource_flags_attribute", "Attribute", base.HEX, resource_attribute, 0x3C)
ssp_fields.pf_resource_flags_allocator    = ProtoField.uint8("dsmcc_ssp_tcp.resource_flags_allocator", "Allocator", base.HEX, resource_allocator, 0x03)
ssp_fields.pf_resource_status             = ProtoField.uint8("dsmcc_ssp_tcp.resource_status", "Resource Status", base.HEX, resource_status)
ssp_fields.pf_resource_length             = ProtoField.new("Resource Length", "dsmcc_ssp_tcp.resource_length", ftypes.UINT16)
ssp_fields.pf_resource_data_field_count   = ProtoField.new("Resource Data Field Count", "dsmcc_ssp_tcp.resource_data_field_count", ftypes.UINT16)
-- resource descriptor 0003 mpeg program
ssp_fields.pf_resource_value_type         = ProtoField.uint16("dsmcc_ssp_tcp.resource_value_type", "Resource Value Type", base.HEX, res_value_type)
ssp_fields.pf_resource_value_count        = ProtoField.new("Resource Value Count", "dsmcc_ssp_tcp.resource_value_count", ftypes.UINT16)
ssp_fields.pf_resource_mpeg_program_num   = ProtoField.new("MPEG Program Number", "dsmcc_ssp_tcp.resource_mpeg_program_num", ftypes.BYTES)
ssp_fields.pf_resource_mpeg_pmt_pid       = ProtoField.new("MPEG PMT PID", "dsmcc_ssp_tcp.resource_mpeg_pmt_pid", ftypes.BYTES)
ssp_fields.pf_resource_mpeg_ca_pid        = ProtoField.new("MPEG CA PID", "dsmcc_ssp_tcp.resource_mpeg_ca_pid", ftypes.BYTES)
ssp_fields.pf_resource_mpeg_stream_count  = ProtoField.new("Elementary Stream Count", "dsmcc_ssp_tcp.resource_mpeg_stream_count", ftypes.UINT16)
ssp_fields.pf_resource_mpeg_pid           = ProtoField.new("MPEG PID", "dsmcc_ssp_tcp.resource_mpeg_pcr", ftypes.BYTES)
ssp_fields.pf_resource_mpeg_stream_type   = ProtoField.new("Stream Type", "dsmcc_ssp_tcp.resource_mpeg_stream_type", ftypes.BYTES)
ssp_fields.pf_resource_mpeg_association_tag = ProtoField.new("Association Tag", "dsmcc_ssp_tcp.resource_mpeg_association_tag", ftypes.BYTES)
ssp_fields.pf_resource_mpeg_pcr           = ProtoField.new("MPEG PCR", "dsmcc_ssp_tcp.resource_mpeg_pcr", ftypes.BYTES)
-- resource descriptor 0004 physical channel
ssp_fields.pf_resource_channel_id         = ProtoField.new("Channel ID (Hz)", "dsmcc_ssp_tcp.resource_channel_id", ftypes.UINT32)
ssp_fields.pf_resource_direction          = ProtoField.uint16("dsmcc_ssp_tcp.resource_direction", "Direction", base.HEX, physical_direction)
-- resource descriptor 0006 ts downstream bandwidth
ssp_fields.pf_resource_ds_bw              = ProtoField.new("Downstream Bandwidth (bps)", "dsmcc_ssp_tcp.resource_ds_bw", ftypes.UINT16)
ssp_fields.pf_resource_value              = ProtoField.new("Resource Value", "dsmcc_ssp_tcp.resource_value", ftypes.BYTES)
ssp_fields.pf_resource_ds_tsid            = ProtoField.new("Downstream Transport Stream ID", "dsmcc_ssp_tcp.resource_ds_tsid", ftypes.UINT16)
-- resource descriptor F001 atsc modulation mode
ssp_fields.pf_resource_trans_system       = ProtoField.uint8("dsmcc_ssp_tcp.resource_trans_system", "Transmission System", base.HEX, transmission_systems)
ssp_fields.pf_resource_inner_coding       = ProtoField.new("Inner Coding Mode", "dsmcc_ssp_tcp.resource_inner_coding", ftypes.BYTES)
ssp_fields.pf_resource_split_bitsream     = ProtoField.new("Split Bitstream Mode", "dsmcc_ssp_tcp.resource_split_bitsream", ftypes.BYTES)
ssp_fields.pf_resource_mod_format         = ProtoField.uint8("dsmcc_ssp_tcp.resource_mod_format", "Modulation Format", base.HEX, mod_format)
ssp_fields.pf_resource_symbol_rate        = ProtoField.new("Symbol Rate", "dsmcc_ssp_tcp.resource_symbol_rate", ftypes.UINT32)
ssp_fields.pf_resource_reserved           = ProtoField.new("Reserved", "dsmcc_ssp_tcp.resource_reserved", ftypes.BYTES)
ssp_fields.pf_resource_interleave_depth   = ProtoField.new("Interleave Depth", "dsmcc_ssp_tcp.resource_interleave_depth", ftypes.BYTES)
ssp_fields.pf_resource_modulation_mode    = ProtoField.new("Modulation Mode", "dsmcc_ssp_tcp.resource_modulation_mode", ftypes.BYTES)
ssp_fields.pf_resource_fec                = ProtoField.uint8("dsmcc_ssp_tcp.resource_fec", "Forward Error Correction", base.HEX, fec)
-- resource descriptor F003 headend id
ssp_fields.pf_resource_headend_flag       = ProtoField.uint16("dsmcc_ssp_tcp.resource_headend_flag", "Headend Flag", base.HEX, headend_flag)
ssp_fields.pf_resource_headend_afi        = ProtoField.new("Headend NSAP (AFI)", "dsmcc_ssp_tcp.resource_server_ca_user_afi", ftypes.BYTES)
ssp_fields.pf_resource_headend_icd        = ProtoField.new("International Code Designator (ICD)", "dsmcc_ssp_tcp.resource_server_ca_user_icd", ftypes.BYTES)
ssp_fields.pf_resource_headend_ip         = ProtoField.new("Headend IP (HO_DSP)", "dsmcc_ssp_tcp.resource_server_ca_user_ip", ftypes.IPv4)
ssp_fields.pf_resource_headend_mac        = ProtoField.new("Headend MAC (ESI)", "dsmcc_ssp_tcp.resource_server_ca_user_mac", ftypes.ETHER)
ssp_fields.pf_resource_headend_sel        = ProtoField.new("NSAP Selector (SEL)", "dsmcc_ssp_tcp.resource_server_ca_user_sel", ftypes.BYTES)
ssp_fields.pf_resource_headend_tsid       = ProtoField.new("Headend TSID", "dsmcc_ssp_tcp.resource_headend_tsid", ftypes.BYTES)
-- resource descriptor F004 server conditional access
ssp_fields.pf_resource_server_ca_system_id   = ProtoField.new("Server CA System ID", "dsmcc_ssp_tcp.resource_server_ca_system_id", ftypes.BYTES)
ssp_fields.pf_resource_server_ca_copyprotect = ProtoField.new("Server CA Copy Protection", "dsmcc_ssp_tcp.resource_server_ca_copyprotect", ftypes.BYTES)
ssp_fields.pf_resource_server_ca_usercount   = ProtoField.new("Server CA User Count", "dsmcc_ssp_tcp.resource_server_ca_usercount", ftypes.UINT16)
ssp_fields.pf_resource_server_ca_userid      = ProtoField.new("Server CA User ID", "dsmcc_ssp_tcp.resource_server_ca_userid", ftypes.BYTES)
ssp_fields.pf_resource_server_ca_user_afi    = ProtoField.new("User NSAP (AFI)", "dsmcc_ssp_tcp.resource_server_ca_user_afi", ftypes.BYTES)
ssp_fields.pf_resource_server_ca_user_icd    = ProtoField.new("International Code Designator (ICD)", "dsmcc_ssp_tcp.resource_server_ca_user_icd", ftypes.BYTES)
ssp_fields.pf_resource_server_ca_user_ip     = ProtoField.new("Server CA User IP (HO_DSP)", "dsmcc_ssp_tcp.resource_server_ca_user_ip", ftypes.IPv4)
ssp_fields.pf_resource_server_ca_user_mac    = ProtoField.new("Server CA User MAC (ESI)", "dsmcc_ssp_tcp.resource_server_ca_user_mac", ftypes.ETHER)
ssp_fields.pf_resource_server_ca_user_sel    = ProtoField.new("NSAP Selector (SEL)", "dsmcc_ssp_tcp.resource_server_ca_user_sel", ftypes.BYTES)
-- resource descriptor F005 client conditional access
ssp_fields.pf_resource_client_ca_system_id   = ProtoField.new("CA System ID", "dsmcc_ssp_tcp.resource_ca_system_id", ftypes.BYTES)
ssp_fields.pf_resource_client_ca_info_length = ProtoField.new("CA Info Length", "dsmcc_ssp_tcp.resource_ca_info_length", ftypes.UINT16)
ssp_fields.pf_resource_client_ca_info_data   = ProtoField.new("CA Info Data", "dsmcc_ssp_tcp.resource_ca_info_data", ftypes.BYTES)
-- resource descriptor F006 ethernet interface
ssp_fields.pf_resource_ethernet_src_udp = ProtoField.new("Ethernet Src UDP", "dsmcc_ssp_tcp.resource_ethernet_src_udp", ftypes.UINT16)
ssp_fields.pf_resource_ethernet_src_ip  = ProtoField.new("Ethernet Src IP", "dsmcc_ssp_tcp.resource_ethernet_src_ip", ftypes.IPv4)
ssp_fields.pf_resource_ethernet_src_mac = ProtoField.new("Ethernet Src Mac", "dsmcc_ssp_tcp.resource_ethernet_src_mac", ftypes.ETHER)
ssp_fields.pf_resource_ethernet_dst_udp = ProtoField.new("Ethernet Dst UDP", "dsmcc_ssp_tcp.resource_ethernet_dst_udp", ftypes.UINT16)
ssp_fields.pf_resource_ethernet_dst_ip  = ProtoField.new("Ethernet Dst IP", "dsmcc_ssp_tcp.resource_ethernet_dst_ip", ftypes.IPv4)
ssp_fields.pf_resource_ethernet_dst_mac = ProtoField.new("Ethernet Dst Mac", "dsmcc_ssp_tcp.resource_ethernet_dst_mac", ftypes.ETHER)
-- resource descriptor F007 service group
ssp_fields.pf_resource_service_group    = ProtoField.new("Service Group", "dsmcc_ssp_tcp.resource_service_group", ftypes.UINT32)
-- service gateway
ssp_fields.pf_sg                        = ProtoField.new("Service Gateway", "dsmcc_ssp_tcp.sg", ftypes.STRING)
ssp_fields.pf_sg_data_length            = ProtoField.new("Service Gateway Data Length", "dsmcc_ssp_tcp.sg_data_length", ftypes.UINT32)
ssp_fields.pf_sg_service                = ProtoField.new("Service Gateway Service", "dsmcc_ssp_tcp.sg_service", ftypes.STRING)
ssp_fields.pf_sg_service_data_length    = ProtoField.new("Service Gateway Service Data Length", "dsmcc_ssp_tcp.sg_service_data_length", ftypes.UINT32)
-- debug, change the ftype based on the actual data type being discovered
ssp_fields.pf_debug   = ProtoField.new("Debug", "dsmcc_ssp_tcp.debug", ftypes.BYTES)
ssp_fields.pf_unknown = ProtoField.new("Unknown or Padding", "dsmcc_ssp_tcp.unknown", ftypes.BYTES)
...
--local ef_query     = ProtoExpert.new("dsmcc_ssp_tcp.query.expert", "SSP query message", expert.group.REQUEST_CODE, expert.severity.CHAT)
--local ef_response  = ProtoExpert.new("dsmcc_ssp_tcp.response.expert", "SSP response message", expert.group.RESPONSE_CODE, expert.severity.CHAT)
local ef_too_short = ProtoExpert.new("dsmcc_ssp_tcp.too_short.expert", "SSP message too short", expert.group.MALFORMED, expert.severity.ERROR)
local ef_bad_descriptor = ProtoExpert.new("dsmcc_ssp_tcp.descriptor.missing.expert", "SSP descriptor missing or malformed", expert.group.MALFORMED, expert.severity.WARN)
...
twcssp.prefs.port  = Pref.uint("Port number", default_settings.port, "The TCP port number for DSMCC SSP")
...
function twcssp.prefs_changed()
    ...
    if default_settings.port ~= twcssp.prefs.port then
        ...
        if default_settings.port ~= 0 then
            ...
            DissectorTable.get("tcp.port"):remove(default_settings.port, twcssp)
        end
        -- set our new default
        ...
        if default_settings.port ~= 0 then
            ...
            DissectorTable.get("tcp.port"):add(default_settings.port, twcssp)
        end
    end
end
...
-- It's the same as doing "dsmcc_ssp_tcp.dissector = function (tvbuf,pkt,root)"
-- The 'tvbuf' is a Tvb object, 'pktinfo' is a Pinfo object, and 'root' is a TreeItem object.
-- Whenever Wireshark dissects a packet that the Proto is hooked into, it will call
-- this function and pass it these arguments for the packet it's dissecting.

-- Handle multiple TCP segments
-- get the message_length field from header
function total_length(tvbuf, pktinfo, root)
    total_len = tvbuf(10,2):uint()
    return total_len
end
-- get the actual full length of the TCP data
function twcssp_tcp_pdus(tvbuf, pinfo, root)
...
-- Protocol dissection starts here!
function twcssp.dissector(tvbuf,pktinfo,root)
    dprint2("dsmcc_ssp_tcp.dissector called!")
    
    -- set the protocol column to show the protocol name
    pktinfo.cols.protocol:set("DSMCC_SSP_TCP")
    ...
    dissect_tcp_pdus(tvbuf, root, 12, total_length, twcssp_tcp_pdus)
    ...
    ---------------------------------------
    --  Server Session Setup Indication  --
    ---------------------------------------
    if messageid == 0x8012 then
        ...
        pos = pos + 4
        pktinfo.cols.info = "Server Session Setup Indication (SSSI), mac="..mac .. ", session="..session        
        ...
        pos = pos + 1
        folder_tree:add(ssp_fields.pf_unknown, tvbuf:range(pos,2))
        pos = pos + 2
        ...
        elseif (protocol_id == 1) then
            ...
            for j=desc_count,1,-1 do
                ...
                elseif (desc_tag == 5) then
                    local desc_tree = folder_tree:add("Application Request Data")
    ...
    elseif messageid == 0x8013 then
        ...
        local session = tvbuf:range(pos,4):uint()
        pos = pos + 4
        pktinfo.cols.info = "Server Session Setup Response (SSSR), mac="..mac .. ", session="..session
        ...
        folder_tree:add(ssp_fields.pf_server_sel, tvbuf:range(pos,1))
        pos = pos + 1
        local folder_tree = tree:add("Next Server NSAP (E.164 ATM)")
        folder_tree:add(ssp_fields.pf_server_nsap_afi, tvbuf:range(pos,1))
        pos = pos + 1
        folder_tree:add(ssp_fields.pf_server_icd, tvbuf:range(pos,8))
        pos = pos + 8
        ...
        --local resource_count = tvbuf:range(pos,2):uint() -- assumed to be 0?
        pos = pos + 2
        local folder_tree = tree:add("User Private Data")
        folder_tree:add(ssp_fields.pf_uudata_length, tvbuf:range(pos,2))
        pos = pos + 2
    ...
    --------------------------------------
    --  Server Session Release Request  --
    --------------------------------------
    elseif messageid == 0x8020 then
        local folder_tree = tree:add("Session")
        folder_tree:add(ssp_fields.pf_stb_address, tvbuf:range(pos,6))
        local mac = tvbuf:range(pos,6)
        pos = pos + 6
        ...
        local session = tvbuf:range(pos,4):uint()
        pos = pos + 4
        pktinfo.cols.info = "Server Session Release Request (SSRR), mac="..mac .. ", session="..session
...
--        end
    ...
    --------------------------------------
    --  Server Session Release Confirm  --
    --------------------------------------
    elseif messageid == 0x8021 then
        local folder_tree = tree:add("Session")
        folder_tree:add(ssp_fields.pf_stb_address, tvbuf:range(pos,6))
        local mac = tvbuf:range(pos,6)
        pos = pos + 6
        ...
        local session = tvbuf:range(pos,4):uint()        
        pos = pos + 4
        pktinfo.cols.info = "Server Session Release Confirm (SSRC), mac="..mac .. ", session="..session
        local folder_tree = tree:add("Response Code")
        folder_tree:add(ssp_fields.pf_response, tvbuf:range(pos,2))
        pos = pos + 1
        local folder_tree = tree:add("User Private Data")
    ...
    -----------------------------------------
    --  Server Session Release Indication  --
    -----------------------------------------
    elseif messageid == 0x8022 then
        local folder_tree = tree:add("Session")
        folder_tree:add(ssp_fields.pf_stb_address, tvbuf:range(pos,6))
        local mac = tvbuf:range(pos,6)
        pos = pos + 6
        ...
        local session = tvbuf:range(pos,4):uint()        
        pos = pos + 4
        pktinfo.cols.info = "Server Session Release Indication (SSRI), mac="..mac .. ", session="..session
        local folder_tree = tree:add("Reason Code")
        folder_tree:add(ssp_fields.pf_reason, tvbuf:range(pos,2))
        pos = pos + 2
        local folder_tree = tree:add("User Private Data")
    ...
    ---------------------------------------
    --  Server Session Release Response  --
    ---------------------------------------
    elseif messageid == 0x8023 then
        local folder_tree = tree:add("Session")
        folder_tree:add(ssp_fields.pf_stb_address, tvbuf:range(pos,6))
        local mac = tvbuf:range(pos,6)
        pos = pos + 6
        ...
        local session = tvbuf:range(pos,4):uint()        
        pos = pos + 4
        pktinfo.cols.info = "Server Session Release Response (SSRR), mac="..mac .. ", session="..session
        local folder_tree = tree:add("User Private Data")
        folder_tree:add(ssp_fields.pf_uudata_length, tvbuf:range(pos,2))
        pos = pos + 2
        folder_tree:add(ssp_fields.pf_private_data_length, tvbuf:range(pos,2))
    ...
    elseif messageid == 0x8030 then
        ...
        local session = tvbuf:range(pos,4):uint()        
        pos = pos + 4
        pktinfo.cols.info = "Server Add Resource Request (SARR), mac="..mac .. ", session="..session
        -- resources
        ...
        if (resource_count > 0) then
            for i=resource_count,1,-1 do
                ...
                if (resource_type == 3) or (resource_type == 6) or (resource_type == 61444) or (resource_type == 61446) or (resource_type == 61447) then
                    ...
                    elseif (resource_type == 61444) then  -- server conditional access
                        ...
                        local usercount = tvbuf:range(pos,2):uint()
                        pos = pos + 2
                        if usercount > 0 then
                            user = 1
                            for i=usercount,1,-1 do
                                local user_list = resource_tree:add("User",user)
    ...
    elseif messageid == 0x8031 then
        ...
        local session = tvbuf:range(pos,4):uint()        
        pos = pos + 4
        pktinfo.cols.info = "Server Add Resource Confirm (SARC), mac="..mac .. ", session="..session
        local folder_tree = tree:add("Response Code")
        folder_tree:add(ssp_fields.pf_response, tvbuf:range(pos,2))
        pos = pos + 2
        -- resources
        ...
        if (resource_count > 0) then
            for i=resource_count,1,-1 do
                ...
                local resource_type = tvbuf:range(pos,2):uint()
                pos = pos + 2
                if (resource_type == 3) or (resource_type == 6) or (resource_type == 61443) or (resource_type == 61444) or (resource_type == 61446) or (resource_type == 61447) then
                    local resource_num_tree = resource_tree:add(ssp_fields.pf_resource_num, tvbuf:range(pos,2))
                    resource_num_tree:add(ssp_fields.pf_flag_resource_num_assignor, tvbuf:range(pos,2))
                    resource_num_tree:add(ssp_fields.pf_flag_resource_num_value, tvbuf:range(pos,2))
                    pos = pos + 2
    ...
    ----------------------------------------------
    --  Server Continuous Feed Session Request  --
    ----------------------------------------------
    elseif messageid == 0x8050 then
        local folder_tree = tree:add("Session")
        pktinfo.cols.info = "Server Continuous Feed Session Request (SCFSR)"
        folder_tree:add("The dissection of Message ID", messageid, "is unsupported at this time.")
        bytes_remaining = pktlen - pos
        if bytes_remaining > 0 then
            folder_tree:add(ssp_fields.pf_unknown, tvbuf:range(pos,bytes_remaining))
        end
    ...
    ----------------------------------------------
    --  Server Continuous Feed Session Confirm  --
    ----------------------------------------------
    elseif messageid == 0x8051 then
        local folder_tree = tree:add("Session")
        pktinfo.cols.info = "Server Continuous Feed Session Confirm (SCFSC)"
        folder_tree:add("The dissection of Message ID", messageid, "is unsupported at this time.")
        bytes_remaining = pktlen - pos
        if bytes_remaining > 0 then
            folder_tree:add(ssp_fields.pf_unknown, tvbuf:range(pos,bytes_remaining))
    ...
    -----------------------------
    elseif messageid == 0x8060 then
        local folder_tree = tree:add("Reason")
        folder_tree:add(ssp_fields.pf_reason, tvbuf:range(pos,2))
        pos = pos + 2
        local folder_tree = tree:add("Server NSAP (E.164 ATM)")
        folder_tree:add(ssp_fields.pf_server_nsap_afi, tvbuf:range(pos,1))
        ...
        folder_tree:add(ssp_fields.pf_server_sel, tvbuf:range(pos,1))
        pos = pos + 1
        -- each status type has custom status bytes that can be parsed
        -- dsm-cc spec page 56
        folder_tree:add(ssp_fields.pf_server_status_type, tvbuf:range(pos,2))
        pos = pos + 2        
        folder_tree:add(ssp_fields.pf_server_status_count, tvbuf:range(pos,2))
        local desc_count = tvbuf:range(pos,2):uint()
        pos = pos + 2
        for j=desc_count,1,-1 do
            folder_tree:add(ssp_fields.pf_server_status_byte, tvbuf:range(pos,1))
            pos = pos + 1
        end
        pktinfo.cols.info = "Server Status Request (SSR)"
        bytes_remaining = pktlen - pos
        if bytes_remaining > 0 then
            folder_tree:add(ssp_fields.pf_unknown, tvbuf:range(pos,bytes_remaining))
        end
    ...
    -----------------------------
    elseif messageid == 0x8061 then
        local folder_tree = tree:add("Response")
        folder_tree:add(ssp_fields.pf_response, tvbuf:range(pos,2))
        pos = pos + 8
        folder_tree:add(ssp_fields.pf_server_status_type, tvbuf:range(pos,2))
        pos = pos + 2        
        ...
        pktinfo.cols.info = "Server Status Confirm (SSC)"
        bytes_remaining = pktlen - pos
        if bytes_remaining > 0 then
            folder_tree:add(ssp_fields.pf_unknown, tvbuf:range(pos,bytes_remaining))
        end
    ...
    --------------------------------------------
    --  Server Session Proceeding Indication  --
    --------------------------------------------
    elseif messageid == 0x8082 then
        local folder_tree = tree:add("Session")
        pktinfo.cols.info = "Server Session Proceeding Indication (SSPI)"
        folder_tree:add("The dissection of Message ID", messageid, "is unsupported at this time.")
        bytes_remaining = pktlen - pos
        if bytes_remaining > 0 then
            folder_tree:add(ssp_fields.pf_unknown, tvbuf:range(pos,bytes_remaining))
    ...
    -----------------------------------------
    --  Server Session InProgress Request  --
    -----------------------------------------
    elseif messageid == 0x80b0 then
        --local folder_tree = tree:add("Session")
        pktinfo.cols.info = "Server Session InProgress Request (SSIR)"
        bytes_remaining = pktlen - pos
        if bytes_remaining > 0 then
            folder_tree:add(ssp_fields.pf_unknown, tvbuf:range(pos,bytes_remaining))
        end
...
----------------------------------------
-- Need to have the protocol dissection invoked for a specific TCP port,
-- so get the TCP dissector table and add the protocol to it
...
--    end
-- test
--    local msg_list = {16400,16401}
--    local msg_len = table.maxn(msg_list)
--    local msg_id = tvbr:range(2,2):uint()
--    for i=msg_len,1,-1 do
--        if msg_list[i] ~= msg_id then
--            if i==0 then
--                tree:add("Unsupported Message ID: ", msg_id)
--                return false
--            end
...
twcssp:register_heuristic("tcp",heur_dissect_ssp)
